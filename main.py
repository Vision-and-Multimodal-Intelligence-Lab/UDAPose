...
def get_args_parser():
    ...
    parser.add_argument("--stage", default="wl", choices=["wl", "ll", "lln", "llh", "lle", "a7m3", "ricoh3"])
    parser.add_argument("--use_ella", action="store_true", default=False)
...
def main(args):
    ...
    if args.dataset_file == "coco":
        ...
        args.exlpose_path = os.environ.get("EDPOSE_ExLPose_PATH")
    elif args.dataset_file == "ehpt":
        args.ehpt_path = os.environ.get("EDPOSE_EHPT_PATH")
    else:
    ...
    if args.onecyclelr:
        ...
        lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, args.epochs, args.lr/16.0)
    else:
