...
class PostProcess(nn.Module):
    ...
    def __init__(
        self, num_select=100, nms_iou_threshold=-1, num_body_points=17
    ) -> None:
        super().__init__()
    ...
    def forward(self, outputs, target_sizes, not_to_xyxy=False, test=False):
        ...
        Z_pred = (
            Z_pred
            * torch.stack([img_w, img_h], dim=1).repeat(1, self.num_body_points)[
                :, None, :
            ]
        )
        ...
        if self.nms_iou_threshold > 0:
            ...
            results = [
                {"scores": s, "labels": l, "boxes": b, "keypoints": k}
