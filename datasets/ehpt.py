...
class CocoDetection(torch.utils.data.Dataset):
    def __init__(self, root_path, image_set, transforms, return_masks):
        ...
        assert image_set == "val", f"{image_set=} for EHPT"

        self.img_folder = root_path
        self.coco = COCO(root_path / "ehpt-xc.json")
    ...
    def __getitem__(self, idx):
        ...
        w, h = self.coco.loadImgs(image_id)[0]["width"], self.coco.loadImgs(image_id)[0]["height"]
